...
export default function Background() {
    return (
        <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            {/* // if you're trying to use the Card Image Overlays, this is how your code could look instead of the style above - both are acceptable, the above example is a better replication and is also cleaner! */}
